...
public class MenuTransaksiJam extends javax.swing.JFrame {
    ...
    public void simpan() {
        if (NamaPelangganTextField.getText().equalsIgnoreCase("")) {
            ...
            try {
                ...
                String sql = "INSERT INTO transaksi (NAMA,NO_TELP,ID_BARANG,JUMLAH,TOTAL) values ('" + NamaPelangganTextField.getText() + "','" + NoTelpTextField.getText() + "','" +
                        IdBarangTextField.getText()+ "','" + JumlahTextField.getText() + "','" + TotalTextField.getText() + "')";
                st.execute(sql);
                reset();
                bersih();                
                datatable();
        ...
        if (i < 0) {
            ...
            try {
                ...
                String sql = "Update transaksi set NAMA = '" + NamaPelangganTextField.getText() + "', NO_TELP = '" + NoTelpTextField.getText() + "',"
                        + "ID_BARANG = '" + IdBarangTextField.getText() + "', JUMLAH = '" + JumlahTextField.getText() + "', TOTAL = '" + TotalTextField.getText() + "' where ID_TRANSAKSI ='" + kd + "'";
                st.execute(sql);
                reset();
                bersih();
                datatable();
    ...
    protected void datatable() {
        Object[] Baris = {"ID_TRANSAKSI", "NAMA", "NO_TELP", "ID_BARANG", "JUMLAH", "TOTAL", "TANGGAL"};
        tabmode = new DefaultTableModel(null, Baris);
        DaftarTransaksiTable.setModel(tabmode);
        try {
            java.sql.Statement stat = conn.createStatement();
            String sql = "select ID_TRANSAKSI, NAMA, NO_TELP, ID_BARANG, JUMLAH, TOTAL, TANGGAL from transaksi inner join barang using (ID_BARANG)";
            ...
            while (hasil.next()) {
                ...
                String[] data = {ID_TRANSAKSI, NAMA, NO_HP, ID_BARANG, JUMLAH, TOTAL, TANGGAL};
                tabmode.addRow(data);
            }
        } catch (SQLException e) {
    ...
    private void initComponents() {
        ...
        SimpanButton1.setBackground(new java.awt.Color(255, 255, 255));
        SimpanButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        SimpanButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/001-save.png"))); // NOI18N
        ...
        BatalButton1.setBackground(new java.awt.Color(255, 255, 255));
        BatalButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        BatalButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/002-cancel.png"))); // NOI18N
        ...
        DaftarTransaksiTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_TRANSAKSI", "NAMA_PELANGGAN", "NO_TELP", "ID_BARANG", "JUMLAH", "TOTAL", "TANGGAL"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(IdBarangTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TotalTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(IdBarangTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void DaftarTransaksiTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DaftarTransaksiTableMouseClicked
        ...
        IdBarangTextField.setText((String) DaftarTransaksiTable.getValueAt(pilih, 3));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuTransaksiJam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuTransaksiJam().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField IdBarangTextField;
